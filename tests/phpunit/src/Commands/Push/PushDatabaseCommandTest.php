...
class PushDatabaseCommandTest extends CommandTestBase {
  ...
  protected function mockUploadDatabaseDump(
    ...
    $command = [
      ...
      'site.dev@server-123.hosted.hosting.acquia.com:/mnt/tmp/profserv2db14390/acli-mysql-dump-drupal.sql.gz',
    ];
  ...
  protected function mockImportDatabaseDumpOnRemote(
    ...
    $ssh_helper->executeCommand(
      ...
      ['pv /mnt/tmp/profserv2db14390/acli-mysql-dump-drupal.sql.gz --bytes --rate | gunzip | MYSQL_PWD=password mysql --host=fsdb-74.enterprise-g1.hosting.acquia.com --user=s164 profserv2db14390'],
      TRUE,
      NULL
    )
      ->willReturn($process->reveal())
