...
class PushDatabaseCommandTest extends CommandTestBase
{
    ...
    private function mockImportDatabaseDumpOnRemote(ObjectProphecy|LocalMachineHelper $localMachineHelper, Process|ObjectProphecy $process, bool $printOutput = true): void
    {
        $cmd = [
            ...
            4 => '-o AddressFamily inet',
            5 => '-o LogLevel=ERROR',
            6 => 'pv /mnt/tmp/profserv2.01dev/acli-mysql-dump-drupal.sql.gz --bytes --rate | gunzip | MYSQL_PWD=' . escapeshellarg('password') . ' mysql --host=fsdb-74.enterprise-g1.hosting.acquia.com.enterprise-g1.hosting.acquia.com --user=s164 profserv2db14390',
        ];
