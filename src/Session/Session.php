...
use Acquia\Ads\Collections\SavedTokens;
use Acquia\Ads\Config\ConfigAwareTrait;
use Acquia\Ads\DataStore\DataStoreAwareInterface;
 ...
 */
class Session implements DataStoreAwareInterface
{
     ...
     * @return mixed
     * @throws AdsException If the given key is not located
     */
     ...
     * @return \Acquia\Ads\Models\User [user] $session user
     */
    ...
    /**
     * @return \Acquia\Ads\Collections\SavedTokens
     */
